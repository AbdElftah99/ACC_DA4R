...
//{
//    public class DataManagementController(APS aps) : ControllerBase
//    {
...
//        //    // the API SDK
//        //    HubsApi hubsApi = new HubsApi(_aps._SDKManager);
//        //    var hubs = await hubsApi.GetHubsAsync();

//        //    foreach (KeyValuePair<string, dynamic> hubInfo in new DynamicDictionaryItems(hubs.Content.Data))
//        //    {

...
namespace ACC_DA4R.Controllers
{
    public class DesignAutomationController : ControllerBase
    {
        ...
        {
            string bucketName = "revitdesigncheck" + Constants.NickName.ToLower();
            ...
            ACCIssuesService issues = new ACCIssuesService();
            string containerIdx = await issues.GetContainerIdAsync(credentials.TokenInternal, projectId);
            await issues.CreateIssueAsync(credentials.TokenInternal, containerIdx, title, description);
